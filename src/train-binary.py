...
from tensorflow.keras.layers import Dropout, Flatten, Dense, Activation, BatchNormalization, Convolution2D, MaxPooling2D, Conv2D
...
train_data_dir = '../../thirdparty/inpredo/data/train/'
validation_data_dir = '../../thirdparty/inpredo/data/validation/'

# Input the size of your sample images
img_width, img_height = 150, 150
# Enter the number of samples, training + validation
nb_train_samples = 12669 + 12382
nb_validation_samples = 3167 + 3095
nb_filters1 = 32
nb_filters2 = 32
nb_filters3 = 64
conv1_size = 3
...
Tensorboard log
"""
target_dir = "../src/models/weights-{epoch:02d}-{val_accuracy:.2f}.hdf5"
